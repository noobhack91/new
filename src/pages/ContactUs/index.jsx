  ...
  return (
    <>
      <div className="bg-gray-900 flex flex-col font-inter gap-8 items-center justify-start mx-auto py-[18px] w-full">
        ...
        <div className="flex flex-col items-center justify-start mb-[26px] w-full">
          ...
          <div className="bg-blue_gray-100_5e flex flex-col items-center justify-start mt-8 p-[101px] md:px-10 sm:px-5 w-full">
            <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between max-w-[1619px] mb-[31px] mx-auto w-full">
              <div className="flex md:flex-1 flex-col gap-[50px] items-center justify-start w-1/4 md:w-full">
                <div className="flex flex-col gap-[29px] items-center justify-start w-full">
                  <div className="bg-gray-900_04 flex flex-col items-start justify-start rounded-[12px] w-auto sm:w-full">
                    <div className="flex flex-col gap-[35px] items-end justify-start w-auto">
                      <div className="flex flex-col gap-[38px] items-start justify-start w-auto">
                        ...
                        >
                          <Text size="txtInterBold22">FAQS</Text>
                        </a>
                        <List
                          className="flex flex-col gap-5 items-start w-auto"
                          orientation="vertical"
                        >
                          <div className="flex flex-col gap-4 items-start justify-start my-0 w-auto">
                            <div className="flex flex-row gap-[49px] items-start justify-start w-auto">
                              <Text
                                className="leading-[20.00px] text-pink-500 text-xl"
                                size="txtInterBold20Pink500"
                              >
                                <>
                                  How to used the save <br />
                                  Search?
                                </>
                              </Text>
                              <Text
                            ...
                            <Text
                              className="leading-[20.00px] max-w-[344px] md:max-w-full text-base text-white-A700"
                              size="txtInterRegular16"
                            >
                              Lorem ipsum dolor sit amet consectetur. In
                              accumsan fermentum iaculis gravida quam amet nunc.
                            </Text>
                          </div>
                          <div className="flex flex-col gap-4 items-start justify-start my-0 w-auto">
                            <div className="flex flex-row gap-[49px] items-start justify-start w-auto">
                      ...
                      <Text
                        className="text-pink-500 text-xl w-auto"
                        size="txtInterBold20Pink500"
                      >
                        View all FAQS
                      </Text>
                  ...
                  <div className="flex flex-col gap-[5px] justify-start w-full">
                    <div className="md:h-[347px] h-[414px] relative w-full">
                      <Text
                        className="absolute left-[1%] text-[22px] sm:text-lg text-white-A700 md:text-xl top-[0]"
                        size="txtInterBold22"
                      >
                        TESTIMONIALS
                      </Text>
                      <div className="absolute md:h-[347px] h-[402px] inset-[0] justify-center m-auto w-full">
                        <div className="absolute bg-gray-900_04 h-[347px] inset-[0] justify-center m-auto rounded-[12px] w-full"></div>
                        <Text
                          className="absolute left-[6%] md:text-5xl text-[129px] text-pink-500 top-[0]"
                          size="txtInterBold129"
                        >
                          “
                        </Text>
                        <Text
                          className="absolute bottom-[16%] leading-[20.00px] right-[4%] text-base text-white-A700 w-[88%] sm:w-full"
                          size="txtInterRegular16"
                        >
                          Lorem ipsum dolor sit amet consectetur. Tortor ornare
                          senectus feugiat pellentesque urna elementum. Suscipit
                          sit odio in gravida morbi. Fermentum cursus sed
                          consequat eu cursus turpis vulputate. Risus libero
                          nunc sagittis nibh in quam turpis ornare. Leo
                          phasellus enim varius placerat. Sit porttitor dui
                          accumsan sollicitudin at sit sed nisl. Vehicula
                          senectus lectus tristique tortor. Quis risus et
                          laoreet sodales nisl. Porttitor id malesuada tristique
                          facilisis.
                        </Text>
                        <Img
                          className="absolute bottom-[0] h-11 left-[7%] w-[43px]"
                          src="images/img_arrowdown_gray_900_04.svg"
                          alt="arrowdown"
                        />
                      </div>
                    </div>
                    <Text
                      className="md:ml-[0] ml-[47px] text-base text-white-A700_7a"
                      size="txtInterRegular16WhiteA7007a"
                    >
                      Jhon Dee
                    </Text>
              ...
              <div className="flex md:flex-1 flex-col items-start justify-start w-[69%] md:w-full">
                ...
                <div className="flex flex-col gap-[25px] items-start justify-start mt-[43px] w-auto md:w-full">
                  <div className="flex md:flex-col flex-row md:gap-10 gap-[248px] items-center justify-between w-auto md:w-full">
                    <Text
                      className="text-[22px] sm:text-lg text-white-A700 md:text-xl w-auto"
                    ...
                    <Img
                      className="h-[70px] w-[784px]"
                      src="images/img_frame236.svg"
                      alt="groupTwentySeven"
                    />
                  </div>
                  <div className="flex md:flex-col flex-row md:gap-10 gap-[251px] items-center justify-between w-auto md:w-full">
                    <Text
                      className="text-[22px] sm:text-lg text-white-A700 md:text-xl w-auto"
                      size="txtInterRegular22WhiteA700"
                    >
                  ...
                  <div className="flex md:flex-col flex-row md:gap-10 gap-[213px] items-start justify-between w-auto md:w-full">
                    <Text
                      className="text-[22px] sm:text-lg text-white-A700 md:text-xl w-auto"
                      size="txtInterRegular22WhiteA700"
                    >
                    ...
                    <Img
                      className="h-[198px] w-[784px]"
                      src="images/img_frame236.svg"
                      alt="groupTwentyNine"
                    />
                  </div>
                  <div className="flex flex-row sm:gap-10 gap-[225px] items-start justify-between w-auto sm:w-full">
                    <Text
                      className="text-[22px] sm:text-lg text-white-A700 md:text-xl w-auto"
                      size="txtInterRegular22WhiteA700"
                    >
                ...
                <div className="flex flex-col items-start justify-start md:ml-[0] ml-[313px] mt-12 w-[132px]">
          ...
          <div className="flex flex-col items-center justify-start max-w-[1625px] mt-[102px] mx-auto md:px-5 w-full">
